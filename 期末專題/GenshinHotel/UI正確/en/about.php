            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav ml-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="about.php">關於我們</a></li>
    ...
    <section class="facilities_area section_gap">
        ...
        <div class="container">
            <div class="section_title text-center">
                <h2 class="title_w">圓神大飯店</h2>
                <p>Genshin Hotel --- Service</p>
            </div>
            <div class="row mb_30">
                <div class="col-lg-4 col-md-6">
                    <div class="facilities_item">
                        <h4 class="sec_h4"><i class="lnr lnr-dinner"></i>餐廳</h4>
                        <p>這家餐廳美食絕佳，服務貼心，環境優雅，氛圍迷人，每一道菜都讓人回味無窮。</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="facilities_item">
                        <h4 class="sec_h4"><i class="lnr lnr-bicycle"></i>健身房</h4>
                        <p>設備先進，環境整潔，氣氛熱烈，是健身愛好者的理想之地。</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="facilities_item">
                        <h4 class="sec_h4"><i class="lnr lnr-shirt"></i>泳池</h4>
                        <p>泳池水質清澈，設施齊全，環境舒適，適合全家享受暢泳的樂趣。</p>
                    </div>
                </div>
            </div>
        </div>
