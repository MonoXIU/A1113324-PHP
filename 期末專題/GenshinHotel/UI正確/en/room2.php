...
<body>
    ...
    <div class="container">
        <h1 class="text-center my-4">家庭豪華房</h1>
        ...
        <div class="col-md-8">
                ...
                <div id="roomCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../image/room2_1.jpg" class="d-block w-100" alt="Room 101 image 1">
                        </div>
                        <div class="carousel-item">
                            <img src="../image/room2_2.jpg" class="d-block w-100" alt="Room 101 image 2">
                        </div>
                        <div class="carousel-item">
                            <img src="../image/room2_3.jpg" class="d-block w-100" alt="Room 101 image 3">
                        </div>
                        <div class="carousel-item">
                            <img src="../image/room2_4.jpg" class="d-block w-100" alt="Room 101 image 4">
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                <div class="booking-form">
                    <h3>訂購資訊</h3>
                    <form action="room2.php" method="post" id="booking-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="service4">額外加床</label>
                            </div>
                        </div>
                        <input type="hidden" name="roomtype" value="room2">
                        <br>
